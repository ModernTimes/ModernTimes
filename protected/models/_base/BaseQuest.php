 ...
 * <br>
 * <p>This is the model base class for the table "{{quest}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Quest".</p>
 * <p>Beware: decimals and floats can show up as strings in the attribute list</p>
 *
 * @package System.Models.Base
 */
abstract class BaseQuest extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Quest|Quests', $n);
	}
	...
	public function relations() {
		return array(
			'characterQuests' => array(self::HAS_MANY, 'CharacterQuests', 'questID'),
			'requirements' => array(self::HAS_MANY, 'Requirement', 'questID'),
		);
	}
