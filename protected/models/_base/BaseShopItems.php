...
abstract class BaseShopItems extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('shopID, itemID, requirementID, cash', 'numerical', 'integerOnly'=>true),
			array('requirementID, cash', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, shopID, itemID, requirementID, cash', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'shopID' => null,
			'itemID' => null,
			'requirementID' => Yii::t('app', 'Requirement'),
			'cash' => Yii::t('app', 'Cash'),
			'shop' => null,
			'item' => null,
		);
