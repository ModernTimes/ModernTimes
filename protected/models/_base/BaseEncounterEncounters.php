...
abstract class BaseEncounterEncounters extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('encounterID, toEncounterID', 'required'),
			array('encounterID, toEncounterID', 'numerical', 'integerOnly'=>true),
			array('id, encounterID, toEncounterID', 'safe', 'on'=>'search'),
		);
	}
