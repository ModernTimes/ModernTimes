...
/**
 * This is the model base class for the table "{{character_skillsets}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CharacterSkillsets".
 *
 * Columns in table "{{character_skillsets}}" available as properties of the model,
 * followed by relations of table "{{character_skillsets}}" available as properties of the model.
 *
 * @property integer $id
