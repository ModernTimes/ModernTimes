...
abstract class BaseCharacterRecipes extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('characterID, recipeID', 'numerical', 'integerOnly'=>true),
			array('id, characterID, recipeID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('app', 'ID'),
			'characterID' => Yii::t('app', 'Character'),
			'recipeID' => Yii::t('app', 'Recipe'),
		);
	}
