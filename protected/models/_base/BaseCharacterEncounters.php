 ...
 * - Encounter encounter
 * <br>
 * <p>This is the model base class for the table "{{character_encounters}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CharacterEncounters".</p>
 * <p>Beware: decimals and floats can show up as strings in the attribute list</p>
 *
 * @package System.Models.Base
 */
abstract class BaseCharacterEncounters extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'CharacterEncounters|CharacterEncounters', $n);
	}
	...
	public function rules() {
		return array(
			array('characterID, encounterID', 'required'),
			array('characterID, encounterID, delay', 'numerical', 'integerOnly'=>true),
			array('delay', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, characterID, encounterID, delay', 'safe', 'on'=>'search'),
		);
	}
