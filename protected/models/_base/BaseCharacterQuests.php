...
abstract class BaseCharacterQuests extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('characterID, questID', 'numerical', 'integerOnly'=>true),
			array('state', 'length', 'max'=>11),
			array('state', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, characterID, questID, state, params', 'safe', 'on'=>'search'),
		);
	}
