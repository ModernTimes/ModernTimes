<div class="well" style="padding-left: 50px; width: <?php echo ($this->character->active ? "330" : "580"); ?>px;">
    ...
    <?php if(!$this->character->active) {
        echo "<div style=\"display: inline-block; margin-left: 30px; position: relative; top: 3px; vertical-align: top\">";
            echo CHtml::link(
