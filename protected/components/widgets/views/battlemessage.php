...
if(!empty($this->msg->skill)) {
    ...
    } elseif ($this->msg->getResultType() == 'failed') {
        echo "<span class='btn-group'><span class='btn btn-mini'><i class='icon-remove-circle'></i> </span><span class='btn btn-mini'>Failed</span>";
